...
export const addItem = (itemType, itemContent) => (dispatch, getState) => {
  ...
  return axios
    .post('https://backend-to-react-app.herokuapp.com/api/note', {
...
export const authenticate = (username, password) => (dispatch) => {
  ...
  return axios
    .post('https://backend-to-react-app.herokuapp.com/api/user/login', {
      username,
      password,
    })
    .then(
...
export const fetchItems = (itemType) => (dispatch, getState) => {
  ...
  return axios
    .get('https://backend-to-react-app.herokuapp.com/api/notes/type', {
      params: {
        type: itemType,
        userID: getState().userID,
      },
...
export const removeItem = (itemType, id) => (dispatch) => {
  ...
  axios
    .delete(`https://backend-to-react-app.herokuapp.com/api/note/${id}`)
    .then(() => {
      dispatch({
